...
> **Note:** This extension is designed for use on a **single Imagine favorite page**, not the overall Favorites listing page. Navigate into a specific favorite to use this extension.
